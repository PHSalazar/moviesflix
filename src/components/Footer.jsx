...
const Footer = () => {
  ...
  links.forEach((link) => {
    link.addEventListener('click', () => {
      document.body.scrollTop = document.documentElement.scrollTop = 0; //rolando para o inicio da pagina
    });
  });
  ...
  return (
    <div className="footer">
      <p>
        ...
        <Link to="/about">Saiba mais</Link> sobre esse projeto.
      </p>
      ...
      <div>
        ...
        >
          ...
          >
            ...
            <a href="https://github.com/PHSalazar/" target={'_blank'}>
              <img
